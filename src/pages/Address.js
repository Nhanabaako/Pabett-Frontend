...
  phone = "+233571901526",
  streetAddress = "Your street here", // ⚠️ Remember to update this actual address!
...
            alignItems="stretch" // Ensures cards are the same height
          >
            {/* 📍 Location Card */}
...
                {/* FIXED: Corrected map link construction */}
                <Link 
                      href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${streetAddress}, ${addressLocality}, Ghana`)}`} 
                      target="_blank" 
...
            {/* 🔗 Social Links Card (Fixed Icon Reference) */}
            <Grid item xs={12} sm={6} md={4}>
              <Card 
                component={motion.div} 
                {...cardAnimation(0.6)}
...
              >
                <Box sx={{ mb: 1.5 }}>
                  {/* FIX: Using the imported Facebook icon as a defined placeholder */}
...
                        const platformName = link.includes('facebook') ? 'Facebook' : 'Instagram'; // Redefining platformName for accessibility
                        
                        if (!Icon) return null; 
                        
                        return (
